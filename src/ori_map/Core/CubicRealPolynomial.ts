 ...
 */
CubicRealPolynomial.computeDiscriminant = function (a: number, b: number, c: number, d: number): number {
    const a2 = a * a;
    const b2 = b * b;
    const c2 = c * c;
    const d2 = d * d;
 ...
 */
CubicRealPolynomial.computeRealRoots = function (a: number, b: number, c: number, d: number): number[] {
    let roots;
    let ratio;
    if (a === 0.0) {
