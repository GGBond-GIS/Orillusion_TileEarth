 ...
 * @private
 */
function scaleToGeodeticSurface (cartesian:Cartesian3, oneOverRadii:Cartesian3, oneOverRadiiSquared:Cartesian3, centerToleranceSquared:number, result?:Cartesian3):Cartesian3|undefined {
    ...
    (result as Cartesian3).x = positionX * xMultiplier;
    (result as Cartesian3).y = positionY * yMultiplier;
    (result as Cartesian3).z = positionZ * zMultiplier;
