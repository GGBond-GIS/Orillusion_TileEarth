...
import { CubicRealPolynomial } from '../../Math/CubicRealPolynomial';
 ...
 */
const QuarticRealPolynomial: any = {};
 ...
 */
QuarticRealPolynomial.computeDiscriminant = function (a: number, b: number, c: number, d: number, e: number): number {
    const a2 = a * a;
    const a3 = a2 * a;
    const b2 = b * b;
    const b3 = b2 * b;
...
function neumark (a3: number, a2: number, a1: number, a0: number): number[] {
 ...
 */
QuarticRealPolynomial.computeRealRoots = function (a: number, b: number, c: number, d: number, e: number): number[] | undefined {
